...
// Constants
const TWITTER_HANDLE = 'bloccdomains';
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;
// Add the domain you will be minting
const tld = '.blocc';
const CONTRACT_ADDRESS = '0xDFf9D2e80F8e6469F97c8F8B5393D126d43a4407';
...
const mintDomain = async () => {
	...
	// 3 chars = 0.2 MATIC, 4 chars = 0.1 MATIC, 5 or more = 0.1 MATIC
	const price = domain.length === 3 ? '0.2' : domain.length === 4 ? '0.1' : '0.1';
...
const updateDomain = async () => {
  ...
  setLoading(false);
	...
	const renderNotConnectedContainer = () => (
      ...
      <img src="https://media.giphy.com/media/AFpik0o4DMsnYGP1ml/giphy-downsized-large.gif" alt="Blocc is hot gif" />
...
const editRecord = (name) => {
  ...
  if (network !== 'Polygon Mainnet') {
    // If not on Polygon Mainnet, render the switch button
  if (network !== 'Polygon Mainnet') {
    return (
      <div className="connect-wallet-container">
		...
		<div className="App">
			<div className="container">
				<div className="header-container">
					<header>
						<div className="left">
							<p className="title">BLOCC Name Service</p>
							<p className="subtitle">Claim your  blockchain domain!</p>
						</div>
